...
/*La clase enfermedad representa una enfermedad la cual tiene tres parametros, y estos *deben cumplir:
*name; este completo en minusculas, ID -> rsXXXX, database: base de datos que provee el ID
*/
class enfermedad {
private:
